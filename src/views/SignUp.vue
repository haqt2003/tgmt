<template>
  <div class="h-[100vh] bg-[#E9E9E9] w-full flex text-[#202224]">
    ...
    <div class="w-[100%] lg:w-[40%] bg-white h-full text-center">
      ...
      <span class="font-bold text-[26px] mt-10 block">Create an account</span>
      ...
      <button
        @click="onSignUp"
        class="bg-[#202224] text-white mt-10 rounded-full w-[80%] sm:w-[60%] xl:w-[50%] py-3 flex items-center gap-3 justify-center mx-auto"
      >
        <img
          v-if="isPending"
          rc="../assets/spin.svg"
...
export default {
  setup() {
    ...
    return { email, password, isPending, onSignUp };
  },
};
</script>
